...
const vendors = [
  ...
  {
    name: 'BASTA ICE CREAM',
    location: 'Cordova, Cebu',
    img: '/icecream3.png',
  },
  {
    name: 'TAMBOK ICE CREAM',
    location: 'Cordova, Cebu',
    img: '/icecream1.png',
  },
  {
    name: 'SABOR ICE CREAM',
    location: 'Cordova, Cebu',
    img: '/icecream2.png',
  },
  {
    name: 'KATAMIS ICE CREAM',
    location: 'Cordova, Cebu',
    img: '/icecream3.png',
  },
  {
  ...
  return (
    ...
    >
      ...
      <section className="px-6 py-6">
        <h1 className="text-2xl font-bold text-white mb-6 tracking-wide">SHOPS AND VENDORS</h1>
          ...
          {vendors.map((vendor, idx) => (
            ...
            >
              <div className="p-4 flex flex-col items-center">
                ...
                <h3 className="text-md font-semibold text-gray-800 mb-1 text-center">{vendor.name}</h3>
                <p className="text-xs text-gray-600 mb-2">{vendor.location}</p>
                <button className="bg-[#FFDDAE] hover:bg-orange-200 text-gray-800 font-semibold text-sm rounded px-4 py-2 shadow transition">
                  View Shop
                </button>
              </div>
            </div>
